<?php 
	...
	$objClick->daterange = $_POST["txtdaterange"];
	...
	switch ($operation) {
		case 'forrange':
			...
			if( count($vew) > 0 ){
				...
				$gcfc = $objClick->get("getclicksforchartrange");
				$jsondata = json_encode($gcfc);
				$gcmc = $objClick->get("ctrmostclickrange");
